...
export function buildFreshDiscoveryTestSummary(query: SearchQuery, providerId: FreshDiscoveryProviderId, useful: FreshDiscoveryUsefulReferenceCount | null, visual: FreshDiscoveryVisualQuality | null, again: FreshDiscoveryWouldUseAgain | null): string {
