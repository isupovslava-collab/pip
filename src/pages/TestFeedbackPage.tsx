...
export function TestFeedbackPage() {
  ...
  return <section className="mx-auto max-w-6xl" aria-labelledby="feedback-dashboard-title">
    ...
    <section className="surface mt-6 p-5 sm:p-7" aria-labelledby="fresh-discovery-metrics-title">
      <p className="eyebrow">Fresh Discovery Metrics</p><h2 id="fresh-discovery-metrics-title" className="mt-2 text-2xl font-semibold text-navy">Fresh Discovery v3</h2>
      ...
      <div className="mt-5 grid gap-5 sm:grid-cols-2"><div><h3 className="font-semibold text-navy">Link quality</h3><FrequencyList items={[["all", summary.freshDiscovery.linkQuality.all], ["most", summary.freshDiscovery.linkQuality.most], ["less than half", summary.freshDiscovery.linkQuality.less_than_half], ["none", summary.freshDiscovery.linkQuality.none]]} /></div><div><h3 className="font-semibold text-navy">Composition diversity (test mode)</h3><FrequencyList items={[["diverse", summary.freshDiscovery.diversity.diverse], ["some duplicates", summary.freshDiscovery.diversity.some_duplicates], ["too similar", summary.freshDiscovery.diversity.too_similar]]} /></div></div>
