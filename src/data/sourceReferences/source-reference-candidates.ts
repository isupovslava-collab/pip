...
export const sourceReferenceCandidates: SourceReference[] = [
  {
    id: 'SRC-0009', verificationStatus: 'source_found', presentationTitle: 'Create + prepare slides', originalSlideTitle: null, curatorLabel: 'TEDx guidance: one clear idea per slide',
    ...
    rightsStatus: 'link-only-no-local-copy', rightsEvidenceUrl: null, reuseRecommendation: 'Link to the guidance only. Do not present it as a verified visual source until a specific page or slide is confirmed.', displayMode: 'source-link-only',
  ...
  {
    id: 'SRC-0010', verificationStatus: 'source_found', presentationTitle: 'Pathways to Success', originalSlideTitle: null, curatorLabel: 'Learning pathway from introduction to workplace practice',
    ...
    rightsStatus: 'cc-by-nc', rightsEvidenceUrl: 'https://www.open.edu/openlearn/about-openlearn/terms-and-conditions', reuseRecommendation: 'Keep source-link-only for this commercial product unless the exact asset licence and page are confirmed.', displayMode: 'source-link-only',
  ...
  {
    id: 'SRC-0011', verificationStatus: 'source_found', presentationTitle: 'DACI decision-making framework', originalSlideTitle: null, curatorLabel: 'Decision roles and decision deadline framework',
    ...
    rightsStatus: 'link-only-no-local-copy', rightsEvidenceUrl: null, reuseRecommendation: 'Link to the playbook; do not copy its templates or brand components.', displayMode: 'source-link-only',
  ...
  {
    id: 'SRC-0012', verificationStatus: 'source_found', presentationTitle: 'UNICEF Annual Report 2024', originalSlideTitle: null, curatorLabel: 'Annual report achievements and financial results',
    ...
    rightsStatus: 'unclear', rightsEvidenceUrl: null, reuseRecommendation: 'Show the official link only until a specific page and its rights are checked.', displayMode: 'source-link-only',
...
export const candidateSourceVerificationReviews: SourceVerificationReview[] = [
  { sourceReferenceId: 'SRC-0009', sourceGate: 'pass', documentGate: 'pass', pageGate: 'fail', visualGate: 'fail', contentTypeGate: 'pass', scenarioGate: 'pass', rightsGate: 'pass', visualReview: 'awaiting_po_review', pipRelevance: 'medium', reviewedAt: checkedAt, notes: ['Guidance source exists; page-level visual is not verified.'] },
  { sourceReferenceId: 'SRC-0010', sourceGate: 'pass', documentGate: 'pass', pageGate: 'fail', visualGate: 'fail', contentTypeGate: 'pass', scenarioGate: 'pass', rightsGate: 'pass', visualReview: 'awaiting_po_review', pipRelevance: 'medium', reviewedAt: checkedAt, notes: ['Learning source exists; exact visual and licence scope need verification.'] },
  { sourceReferenceId: 'SRC-0011', sourceGate: 'pass', documentGate: 'fail', pageGate: 'fail', visualGate: 'fail', contentTypeGate: 'pass', scenarioGate: 'pass', rightsGate: 'pass', visualReview: 'awaiting_po_review', pipRelevance: 'medium', reviewedAt: checkedAt, notes: ['Web playbook exists; no specific report page is claimed.'] },
  { sourceReferenceId: 'SRC-0012', sourceGate: 'pass', documentGate: 'pass', pageGate: 'fail', visualGate: 'fail', contentTypeGate: 'fail', scenarioGate: 'pass', rightsGate: 'fail', visualReview: 'awaiting_po_review', pipRelevance: 'medium', reviewedAt: checkedAt, notes: ['Publication identity is confirmed; page, content type and rights remain open.'] },
]
