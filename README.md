...
**Статус:** MVP v0.3 — 100-reference library
...
- детерминированное ранжирование 100 синтетических референсов;
...
Библиотека из 100 референсов находится в `public/data/references.json`, а схема — в `reference.schema.json`. Каждый референс содержит уникальный ID, локальное SVG-превью, параметры соответствия, рекомендации по применению и восемь показателей профиля дизайна. Текущие квоты опубликованы в `docs/library-coverage.md`, а правила сопровождения — в `docs/reference-library-guidelines.md`.
